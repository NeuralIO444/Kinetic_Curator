 ...
 * FEED operators (#345).
 *
 * luma is a scalar ψ on a grid. Two honest 2D reads:
 *
 *   GRADIENT  u = ∂ψ/∂x,  v = ∂ψ/∂y     — flow *off* the ink (smear / bloom)
 *   CURL      u = ∂ψ/∂y,  v = -∂ψ/∂x    — flow *along* isolines (smoke)
 *
 * Discrete central differences, clamped edges. Default FEED encoding is curl:
 * ACCUM already fades; smoke is advection around mass, not explosion.
 */
...
/** Mean |div| and mean |curl_z| of an RG field. Interior only. */
